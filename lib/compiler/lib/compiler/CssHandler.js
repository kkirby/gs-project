...
module.exports = (function(){
	...
	function preCompileFile(state,file){
		...
		.replace(/__SYS__/g,state.compiler.config.alias.sys)
		.replace(/@\s*(?!at-root|debug|each|error|for|function|if|import|include|media|mixin|warn|while|return|else|content|font-face)/g,'@include ')
