...
module.exports = (function(){
	...
	Compiler.prototype = {
		...
		handleGsCompileError: function(state,error){
			console.log("\007");
			...
			try {
				...
				console.log('Unable to compile. Got an error while trying to pretty-print error.');
				console.log(e);
				console.log(error.message);
			}
			console.log("\007");
				...
				try {
					...
					gs.compile(
						...
						function(result){
							...
							var preloadScript = [
								'var PreloadAllImages = function(cb){',
						...
						this.handleGsCompileError.bind(this,state)
					);
				}
				catch(e){
					this.compiling = false;
